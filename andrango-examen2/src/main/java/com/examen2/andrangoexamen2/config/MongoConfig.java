package com.examen2.andrangoexamen2.config;
...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return this.applicationValues.database;
    }

    @Override
    public MongoClient mongoClient() {

        return MongoClients.create("mongodb+srv://" + applicationValues.getUsername() +
                ":" + applicationValues.getPassword() +
                "@" + applicationValues.getHost() +
                "/" + applicationValues.getDatabase() +
